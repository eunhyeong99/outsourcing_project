...
public class Store extends Timestamped {
  ...
  private Store(final String name, final int minOrderPrice, final boolean isOwner,
      final StoreStatus role, final Time openTime, final Time closeTime,
      final User user) {
    this.name = name;
  ...
  public static Store createStore(final String name, final int minOrderPrice, final boolean isOwner,
      final StoreStatus role, final Time openTime, final Time closeTime,
      final User user) {
